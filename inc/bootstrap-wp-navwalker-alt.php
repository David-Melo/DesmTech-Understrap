 ...
 */
class WP_Bootstrap_Navwalker_Alt extends Walker_Nav_Menu
{
    /**
...
$output .= $indent . '<li class="divider" role="presentation">';
    ...
    $class_names = $value = '';
    $classes     = empty($item->classes) ? array(['col']) : (array) $item->classes;
    ...
    */
    ...
    // we will add the icon back in via a <span> below so it aligns with
            ...
            $class_names = $class_names ? ' class="col text-center' . esc_attr($class_names) . '"' : '';
...
$atts['class'] = 'nav-link text-center';
}
